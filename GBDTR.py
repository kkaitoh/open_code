...
# 勾配ブースティング木による回帰モデル（GBDTR）実行スクリプト
...
def optimized_function(X, y, trial):
    ...
    # クロスバリデーションの条件設定
    validation_result = cross_validate(GradientBoostingRegressor(**params, random_state = 0), X, y, scoring = "r2", 
...
# モデル構築
rgr = GradientBoostingRegressor(**best_params, random_state = 0)
